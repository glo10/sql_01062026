...
UPDATE employes SET nom="Dia Cohen" WHERE nom='Dia';
-- Bonne manière d'écrire la requête est de cibler la clé primaire dans le WHERE
UPDATE employes SET nom="Dia Cohen" WHERE no_employe=10;
...
UPDATE employes SET titre="Mme", salaire=salaire*1.3 WHERE no_employe=11;
